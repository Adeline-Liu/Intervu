    ...
    <div>
      ...
      <div role="main">
        ...
        <section className="px-[100px] py-[50px] items-center bg-beige">
          <h1
            id="Dashboard"
            className="text-6xl font-bold text-darkBlue max-w-5xl leading-20"
          >
            Dashboard
          </h1>
        ...
        <div role="region" aria-labelledby="Dashboard">
          ...
          {/* Practice with AI */}
          <section
            className="px-[100px] py-[50px] items-center bg-darkPurple"
            role="region"
            aria-labelledby="PracticeNow"
          >
            <h1
              id="PracticeNow"
              className="text-5xl font-bold text-white w-full text-center my-[30px]"
            >
