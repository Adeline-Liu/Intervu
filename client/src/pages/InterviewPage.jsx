      ...
      >
        {paragraphs.map((para, index) => (
          <p
            ...
            className="text-2xl leading-10 py-[5px] text-wrap break-words"
          >
            {para.text}
          </p>
        ))}
...
const InterviewPage = () => {
  ...
  const [paragraphs, setParagraphs] = useState([
    {
      text: "Welcome to Intervu! Click start to start the mock interview.",
      color: "white",
    },
  ]);
  ...
  const startResponding = () => {
    if (!recognitionRef.current) {
      ...
      recognitionRef.current.onerror = (event) => {
        addParagraph(
          "Microphone isn't enabled or an error occurred during speech recognition",
          "red"
        );
        setInterviewState("responding");
      };
  ...
  return (
    <div>
      ...
      <div role="main">
        <section
          className="px-[100px] py-[50px] items-center bg-navyBlue"
          role="region"
          aria-labelledby="MockInterview"
          ...
          <div className="flex justify-between">
            <div className="w-2/5">
              <h1
                ...
                className="text-6xl font-bold text-beige max-w-5xl leading-20"
              >
                {" "}
                Mock Interview{" "}
              </h1>
              ...
              <button
                className={`font-semibold text-center text-3xl bg-slateBlue text-white my-[50px] px-[50px] py-[20px] rounded-md hover:bg-[#28416B] transition-colors ${
                  !questionsLoaded ? "opacity-50 cursor-not-allowed" : ""
                }`}
                role="button"
              ...
              >
                {!questionsLoaded
                  ...
                  ? "Asking question"
                  : interviewState === "doneAsking"
                  ? "Start responding"
                  : interviewState === "responding"
                  ? "Stop responding"
                  : interviewState === "stopping"
                  ? "Stopping response"
          ...
          <div className="px-[100px] py-[50px] items-center bg-navyBlue">
            ...
            <div className="bg-darkBlue px-[50px] py-[30px] rounded-[15px]">
              {feedback.length === 0 ? (
                ...
                <p className="text-2xl font-semibold text-white w-full">
                  {feedback}
                </p>
              )}
