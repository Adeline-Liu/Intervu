...
const CoverPage = () => {
  ...
  return (
    <div>
      <Header />
      <section className="relative text-left bg-beige screen_height">
        {/* Title section */}
      ...
      {/* Info section */}
      <section className="bg-darkGolden relative z-10 p-10 px-[100px] py-[50px]">
        <div
        ...
        <div>
          ...
          <div className="space-y-10 ml-6 text-3xl">
            {[
              "Upload your resume",
